...
def final_compare(hands, potential_winner_index, all_players):
    ...
    if len(potential_winner_index) == 1:
        ...
        hand = equal_hands[0]
        if hand.category == 8:
            return 1, determine_winner_four_of_a_kind(equal_hands, all_players, potential_winner_index)
        if hand.category == 7:
            return 1, determine_winner([2, 0], equal_hands, all_players, potential_winner_index)
        if hand.category == 4:
            return 1, determine_winner([2, 1, 0], equal_hands, all_players, potential_winner_index)
        if hand.category == 3:
            return 1, determine_winner([4, 2, 0], equal_hands, all_players, potential_winner_index)
        if hand.category == 2:
            return 1, determine_winner([4, 2, 1, 0], equal_hands, all_players, potential_winner_index)
        if hand.category == 1 or hand.category == 6:
            return 1, determine_winner([4, 3, 2, 1, 0], equal_hands, all_players, potential_winner_index)
        if hand.category in [5, 9]:
            return 1, determine_winner_straight(equal_hands, all_players, potential_winner_index)
