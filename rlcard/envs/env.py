...
class Env(object):
    ...
    def __init__(self, config):
        ...
        self.game_over_print = config['game_over_print']
    ...
    def run(self, is_training=False):
        ...
        # Payoffs
        win_condition, winners, payoffs = self.get_payoffs()

        if self.game_over_print:
            self.game.game_over_print(win_condition, winners, payoffs)
